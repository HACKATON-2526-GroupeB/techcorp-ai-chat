...
⚠️ **Le risque n'est pas éliminé à la source** : `finance_dataset_final.json` contient toujours les 497 entrées empoisonnées. Un re-fine-tuning sur ce dataset reconstituerait la backdoor.  
